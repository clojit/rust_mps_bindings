...
pub const MPS_RES_OK: ::libc::c_uint = 0;
pub const MPS_RES_FAIL: ::libc::c_uint = 1;
pub const MPS_RES_RESOURCE: ::libc::c_uint = 2;
pub const MPS_RES_MEMORY: ::libc::c_uint = 3;
pub const MPS_RES_LIMIT: ::libc::c_uint = 4;
pub const MPS_RES_UNIMPL: ::libc::c_uint = 5;
pub const MPS_RES_IO: ::libc::c_uint = 6;
pub const MPS_RES_COMMIT_LIMIT: ::libc::c_uint = 7;
pub const MPS_RES_PARAM: ::libc::c_uint = 8;
pub const _mps_MPS_RES_LIMIT: ::libc::c_uint = 9;
